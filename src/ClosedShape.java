...
public class ClosedShape {
	...
	/**
	 * Determines if the shape is pulse or alternate
	 * with other shapes.
	 */
	protected boolean flagPulseAlternate;
	 ...
	 */
	protected ClosedShape (int insertionTime, int x, int y, int vx, int vy, Color colour, boolean isFilled, boolean flagPulseAlternate) {
		this.xPos = x;
		this.yPos = y;
		this.xVec = vx;
		this.yVec = vy;
		...
		this.flagPulseAlternate = flagPulseAlternate;
	}
	 ...
	 */
	 ...
	 /**
	  * This method override the method 
	  * on the other shapes.
	  */
	 ...
	 /**
	  * @return flagPulseAlternate
	  */
	 public boolean getflagPulseAlternate() {
		 return flagPulseAlternate;
	 }
}
